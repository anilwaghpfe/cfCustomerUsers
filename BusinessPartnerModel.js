...
// Node js data model models/BusinessPartnerModel.js';
const kind = 'BusinessPartner';
...
if( process.env.GOOGLE_CLOUD_PROJECT ){
    ...
    console.log('BusinessPartnerModel: Project ID ', projectId);
}

console.log('BusinessPartner: projectId', projectId);
...
exports.getEntityById = function(id, callback){
    
    var key = { 'namespace' : namespace, 'kind' : kind, 'id' : id } ;
